...
@media screen and (max-width:500px){
    ...
    <body>
            ...
            <h1 style="text-align: center;"><u>Add Account</u></h1>
                        
            <form class="form-signin" action="addaccount" method="POST">
                ...
                <input class="btn btn-success btn-block" type="submit" value="Add Account" style="color:white;"><br/>
