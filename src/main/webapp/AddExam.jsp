...
@media screen and (max-width:500px){
    ...
    <body>
            ...
            <h1 style="text-align: center;"><u>Add Exam</u></h1>
                        
            <form class="form-signin" action="addexam" method="POST">

                <input type="text" class="form-control" placeholder="Subject" required="" name="subjectname" />
                <input type="text" class="form-control" placeholder="Duration" required="" name="duration" />
  
                
                <input class="btn btn-success btn-block" type="submit" value="Add Exam" style="color:white;"><br/>
