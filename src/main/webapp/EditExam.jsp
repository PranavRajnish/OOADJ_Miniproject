        ...
        <main role="main">
            <div class="jumbotron">
              <div class="container">
                ...
                <input type="submit" class="btn btn-md btn-primary" name="addQ_button" value="AddQuestions" />
                <input type="submit" class="btn btn-md btn-primary" name="view_button" value="ViewExam" />
                 <%
